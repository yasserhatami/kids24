<template>
    <div class="width mx-auto">
        <v-sheet class="mx-auto w-100 rounded-lg  mb-14 card">
            ...
            <v-btn @click="login" block class="mt-5 py-6 bg-progreen text-prowhite text-h6">ثبت</v-btn>
        </v-sheet>
    </div>
</template>
...
//get validPhoneNumber from server
let validPhoneNumber = ref(true)
function login() {
    if (validPhoneNumber) {
        return navigateTo('/athentication/loginBySms')
    }
}
</script>
<style scoped>
